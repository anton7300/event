...
return [
    ...
    */
    ...
    'between' => [
        ...
        'array' => ':attribute должен быть между :min и :max параметрами.',
    ],
    ...
    'lte' => [
        ...
        'array' => ':attribute не должен иметь больше чем :value элементов.',
    ],
    'max' => [
    ...
    'required_if' => ':attribute обязателен, когда :other является :value.',
    'required_unless' => ':attribute обязателен, если :other не находится в :values.',
    'required_with' => ':attribute обязателен, когда присутствует :values.',
    'required_with_all' => ':attribute обязателен, когда существует :values.',
    'required_without' => ':attribute обязателен, когда :values не существует.',
    'required_without_all' => ':attribute обязателен, если ни одно из :values не присутствует.',
    ...
    'url' => 'Формат :attribute не верный.',
